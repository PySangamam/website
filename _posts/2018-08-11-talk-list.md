...
Author of the talk had been forced to put up with poorly designed EMRs
...
feature rich and a rich easy to use UI that suits workflow that a
typical doctor uses.
...
doctor does things in a particular order and designs the software
...
softwares are designed for billing / coding purposes the medical
...
clinician, first. AuShadha is aimed at making doctor's workflow easier
...
not faster. In this presentation, we will cover over the basic GPU
...
Technology. Her achievements include winning the Smart India Hackathon
2017
(https://www.business-standard.com/article/news-ani/next-tech-lab-from-srm-university-dominates-smart-india-hackathon-2017-117040400729_1.html)
...
IEEE Xplore Papers (https://ieeexplore.ieee.org/document/8293259/),
(https://ieeexplore.ieee.org/document/7977665/) and 1 Elsevier
(https://www.sciencedirect.com/science/article/pii/S1876610217324645)
...
data loading in maching learning.
